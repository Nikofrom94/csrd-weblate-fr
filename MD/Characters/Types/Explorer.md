...
- [Pratique de toutes les armes](../Abilities/Practiced%20With%20All%20Weapons.md)
...
Choisissez quatre des capacités ci-dessous (ou du rang inférieur) pour l'ajouter à votre répertoire. Vous pouvez en plus remplacer l'une de vos capacités de rang inférieur par une différente d'un rang inférieur.
...
- [Inspire des actions coordonnées](../Abilities/Inspire%20Coordinated%20Actions.md)
